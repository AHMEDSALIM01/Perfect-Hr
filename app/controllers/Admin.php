  ...
  class Admin extends Controller {
            ...
            if(isset($_POST['addAccount'])){
                if(!empty($_POST['email'])){
                  $data=[
                    'id' => $_POST['id'],
                    'email' => $_POST['email'],
                    'password' => md5(password_generate(8)),
    ...
    public function newMessage(){
      $data=[
        ...
        'countm' =>$this->messageModel->getCountNotRead() ? $this->messageModel->getCountNotRead() : "",
        'messages'=> $this->messageModel->getAllMessagesEmploye() ? $this->messageModel->getAllMessagesEmploye():[],
        'employes'=> $this->adminModel->getAllEmployeActive() ? $this->adminModel->getAllEmployeActive():[],
    ...
    public function documents(){
      ...
      if(isset($_SESSION['role']) && $_SESSION['role'] =="admin"){
              ...
              if(isset($_POST['suivant'])){
                ...
                if($data['id_employe'] != "" && $data['salaire_employe'] != "" && $data['type'] != "" && $data['lieu'] != ""){
                  $datas=[
