                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in overflow-auto scrollbar-dusty-grass"
                                ...
                                <span class="dropdown-header py-0 d-flex align-items-center justify-content-between">
                                    ...
                                    <a style="cursor:pointer;" href="<?php echo URLROOT.'/admin/newMessage'?>" id="newMessage"><i class="fa-solid fa-plus fa-lg fa-fw text-white"></i></a>
                                </span>
                                <?php if(!empty($data['messages'])){
                                foreach($data['messages'] as $message){
                                ?>
                                <a class="dropdown-item d-flex align-items-center" style="<?php if($message->status_message=='non lus'){echo '';}else{echo 'background-color:#f5f6f9';}?>" href="<?php echo URLROOT.'/admin/readMessage/'.$message->id_message ?>">
