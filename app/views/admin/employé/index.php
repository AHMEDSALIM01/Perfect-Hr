...
<body id="page-top">
                                        ...
                                        <table class="table table-borderless table-hover table-striped " id="dataTable" width="100%" cellspacing="10px" style="font-size:12px;">
                                            ...
                                            <tbody>
                                                <tr class="text-center align-middle">
                                                    ...
                                                    <td ><span class="<?php if(isset($employe) && $employe->status=="active"){echo "text-success text-center";}elseif(isset($employe) && $employe->status=="desactive"){echo "text-danger fw-bold text-center";}?>"><?php echo $employe->status.' ';?><i class="fa-solid fa-fw fs-6 fa-circle" style="font-size:7px; line-height:7px;"></i></span></td>
                                                    <td id="activeCompte" class="btn btn-outline-light text-success btn-sm "><a href="<?php if($employe->status=='active'){echo '#';}else{echo URLROOT.'/admin/addaccount/'.$employe->id_employe;} ?>" class="text-success"><i class="fa-solid fa-sm fa-fw fa-circle-plus"></i></a></td>
                                                    <td class="btn btn-outline-light btn-sm "><a href="<?php if($employe->status!='active'){echo '#';}else{echo URLROOT.'/admin/desactivercompte/'.$employe->id_employe;} ?>" class="text-danger"><i class="fa-solid fa-md fa-fw fa-close"></i></a</td>
    ...
    <script>
        ...
        let regexTelephone=/^[0-9]{8}$/;
        let regexEmail=/^[a-zA-Z0-9._-]+@[a-z0-9._-]{2,}\.[a-z]{2,4}$/;
        let regexCin=/^[A-Z0-9]{8}$/;
        let regexAdress=/^[a-zA-Z0-9]{2,}$/;
        let regexNCNSS=/^[0-9]{8}$/;
        let regexCompteBancaire=/^[0-9]{16}$/;
