                    ...
                    <div class="row">
                        ...
                        <div class="card border-left-primary shadow py-2 overflow-auto scrollbar-dusty-grass" id="tableListe" style="max-height:350px;">
                                ...
                                <div class="card-body px-4">
                                    <div >
                                        <img class="mb-2" style="width=50px; height:50px; border-radius:50%" src="<?php echo URLROOT.'/public/img/'.$data['message']->image?>" alt="">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <p class="d-flex flex-column">
                                                <span>De: <?php echo $data['message']->nom_complet?> (<?php echo $data['message']->email?>)</span>
                                            </p>
                                            <p>
                                                <span><?php echo $data['message']->date_employe ?></span>
                                            </p> 
                                        </div>
                                    ...
                                    <p>
                                    <?php echo $data['message']->message_employe ?>
                                    </p>
                                    ...
                                    <button class="btn btn-outline-primary" id="répondre">Répondre</button>                               
                                </div>
                            </div>
                        </div>
                    </div>
