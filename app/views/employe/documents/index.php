                                        ...
                                        <table class="table table-borderless table-hover table-striped " id="dataTable" width="100%" cellspacing="10px" style="font-size:12px;">
                                            ...
                                            <tbody>
                                                <tr class="text-center align-middle">
                                                    ...
                                                    <td id="download" class="btn btn-outline-light btn-sm "><a href=<?php if($attestation->type_document =='attestation de travail'){echo URLROOT.'/employe/attestationTravail/'.$attestation->id_document;}else{echo URLROOT.'/employe/attestationSalaire/'.$attestation->id_document;}?> class="text-decoration-none text-primary"><i class="fa-solid fa-sm fa-fw fa-download"></i></a></td>
                                                </tr>
                                                <?php
                                                    }}
                                                ?>
